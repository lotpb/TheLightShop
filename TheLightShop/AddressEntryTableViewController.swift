...
class AddressEntryTableViewController: UITableViewController, UIPickerViewDelegate, UIPickerViewDataSource, SwitchTableViewCellDelegate, TextEntryTableViewCellDelegate {
    ...
    private var countryFieldIdentifier = "country"
    ...
    override func viewDidLoad() {
        ...
        for field in fields {
            ...
            let userPresentableName = field.replacingOccurrences(of: "_", with: " ")
        ...
        if (countryArray == nil) {
            ...
            SwiftSpinner.show("Loading countries", animated: true)
            ...
            Moltin.sharedInstance().address.fields(withCustomerId: "", andAddressId: "", success: { (response) -> Void in
                ...
                //self.countryArray? = self.countryArray!.sort(isOrderedBefore: { $0["name"] < $1["name"]})
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if ((indexPath as NSIndexPath).row == contactFieldsArray.count && !isShippingAddress) {
            ...
            cell.switchLabel?.tintColor = Color.moltinColor
            cell.delegate = self
            return cell
    ...
    func getAddressDict() -> Dictionary<String, String> {
        ...
        if countryArray != nil {
            country = "United States" //countryArray![selectedCountryIndex!]["code"]
