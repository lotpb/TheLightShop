...
class CartTableViewCell: UITableViewCell {
    ...
    func setItemDictionary(_ itemDict: NSDictionary) {
        ...
        itemTitleLabel?.font = Font.collectlabel1
        itemTitleLabel?.textColor = Color.moltinColor
        itemQuantityLabel?.font = Font.collectlabel1
        itemQuantityLabel?.textColor = Color.moltinColor
        
        itemTotal?.text = itemDict.value(forKeyPath: "pricing.formatted.without_tax") as? String
